...
namespace Atnic\LumenGenerator\Filters;

use Atnic\LumenGenerator\Database\Eloquent\Relations\BelongsToOne;
use Atnic\LumenGenerator\Database\Eloquent\Relations\BelongsToThrough;
...
class BaseFilter extends Filter
{
    ...
    {
        parent::__construct(clone ($request ?? app('request')));
    ...
    {
        $validator = app('validator')->make([ 'value' => $value ], [ 'value' => 'string' ]);
    ...
    public function sort($value)
    {
        ...
        $validator = app('validator')->make([ 'sorts' => $sorts ], [
    ...
    {
        $validator = app('validator')->make([ 'value' => $value ], [ 'value' => 'numeric|min:1|max:1000' ]);
    ...
    public function keys($values)
    {
        ...
        $validator = app('validator')->make([ 'values' => $keys ], [ 'values.*' => 'exists:'.$model->getTable().','.$model->getKeyName() ]);
    ...
    public function appends($value)
    {
        ...
        $validator = app('validator')->make([ 'values' => $appends ], [ 'values.*' => 'string' ]);
    ...
    public function has($values)
    {
        ...
        $validator = app('validator')->make([ 'values' => $hases ], [ 'values' => 'array|min:1' ]);
    ...
    public function doesnt_have($values)
    {
        ...
        $validator = app('validator')->make([ 'values' => $doesnt_haves ], [ 'values' => 'array|min:1' ]);
